...
class NormalizerFactory:
    ...
    @staticmethod
    def create(normalizer_type: Union[Literal['zscore', 'minmax', 'identity'], None],
               global_normalizer: bool = True):
        if normalizer_type == 'zscore':
            return ZScore(global_normalizer)
        elif normalizer_type == 'minmax':
            return MinMax(global_normalizer)
        elif normalizer_type == 'identity' or normalizer_type is None:
